...
public class EmailNotifier {
    private static final String USERNAME = "dongtrantphcm1090@gmail.com";  // Gmail gửi cảnh báo
    private static final String PASSWORD = "ukdz gfxf vaef mxhh";            // App password Gmail
    private static final String TO_EMAIL = "dongtrantphcm1090@gmail.com";  // Email nhận cảnh báo
